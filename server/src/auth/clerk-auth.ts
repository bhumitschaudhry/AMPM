// CLERK DISABLED — Clerk session token verification is commented out.
// Restore this file and re-enable the POST /clerk route in auth-routes.ts to bring back Google OAuth.
...
// Placeholder export so the import in auth-routes.ts can be cleanly restored when needed.
// This file is intentionally empty while Clerk is disabled.
export {};
