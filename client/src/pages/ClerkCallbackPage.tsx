// CLERK DISABLED — this entire page is unreachable while Clerk is commented out.
// The /sso-callback route in App.tsx is also commented out.
// Uncomment this file and restore App.tsx to re-enable Google OAuth via Clerk.

import { Navigate } from 'react-router-dom';

/** Redirect to login — Clerk OAuth is currently disabled. */
export default function ClerkCallbackPage() {
  return <Navigate to="/login" replace />;
}

// CLERK DISABLED — original implementation preserved below:
//
